...
$OscCommand = "& '$AisiPython' -m aisi.app.sim_scene_to_osc --scene '$VisionScene' --tracking-only --tracking-table-id table_00 --study-active-binding '$StudyActiveTrackBinding' --study-table-tracks-binding '$StudyTableTracksBinding' --host 127.0.0.1 --port 9000 --interval 0.01"
